...
class ManageButtonsView: UIButton {
    ...
    */
    ...
    override func layoutSubviews() {
        ...
        layer.borderColor = isSelected ? ManageButtonsConstants.isSelected : color
    ...
    private struct ManageButtonsConstants {
        ...
        static let boderColor = UIColor.white.cgColor
        static let isSelected = UIColor.red.cgColor
    }
